...
public class ExtendStoreHouseHeader extends View implements PtrUIHandler {

    public static final String TAG = "StoreHouseHeader";
    ...
    public void setActionBar(View mActionBar) {
        this.mActionBar = mActionBar;
    }

    private View mActionBar;

    public ExtendStoreHouseHeader(Context context) {
        super(context);
        initView();
    }

    public ExtendStoreHouseHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public ExtendStoreHouseHeader(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public ExtendStoreHouseHeader setLineWidth(int width) {
        mLineWidth = width;
    ...
    public ExtendStoreHouseHeader setTextColor(int color) {
        mTextColor = color;
        for (int i = 0; i < mItemList.size(); i++) {
    ...
    public ExtendStoreHouseHeader setDropHeight(int height) {
        mDropHeight = height;
        return this;
    }
    ...
    public void onUIPositionChange(PtrFrameLayout frame, boolean isUnderTouch, byte status, PtrIndicator ptrIndicator) {
        if (mActionBar!=null){
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
                mActionBar.setAlpha(1-1*ptrIndicator.getCurrentPercent());
            }
        }
